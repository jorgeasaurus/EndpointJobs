...
The scheduled refresh asks the broad country-aware providers for the US, Switzerland, Italy, Spain, France, Germany, Brazil, Argentina, Chile, Colombia, and Peru. Adzuna adds Brazil (`br`) among those markets; it does not expose Argentina, Chile, Colombia, or Peru, so those four are queried through TheirStack, RapidAPI Daily International Jobs, and RapidAPI LinkedIn. SerpAPI stays on the US (26 searches) plus Australia (2) to remain under the 1,000/month quota: at most 868 in a 31-day month, leaving 132 of the plan. South America is not added to SerpAPI.
